        ...
        <div className="card-body">
            <form className="needs-validation" onSubmit={submithandler}>
                <div className="row">
                    <div className="col-md-4">
                        <div className="form-group">
                            <label className="form-control-label" htmlFor="example3cols1Input">Product Line <span className="text-danger">*</span></label>
                            <input type="text" ref={emailRef} type="email" onChange={emailChangeHandler} onBlur={emailBlurHandler} className={emailvalid} id="example3cols1Input" placeholder="Product Line"/>
                            {!emailIsValid && <div className="invalid-feedback">Should not be empty</div>}
                        </div>
                    </div>
                    <div className="col-md-4">
                        <div className="form-group">
                            <label className="form-control-label" htmlFor="example3cols2Input">Business Unit <span className="text-danger">*</span></label>
                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className="form-group">
                            <label className="form-control-label" htmlFor="example3cols2Input">Pole / Department <span className="text-danger">*</span></label>
                            <Selec multi={true} ref={buRef} choiceHandler={choiceHandler} full={false}  data={budata} ></Selec>
                        </div>
                    </div>
                </div>
