          ...
          <div className="row">
            <div className="col-md-4">
              <div className="form-group">
                <label className="form-control-label" htmlFor="example3cols1Input">Department - Pole <span className="text-danger">*</span></label>
                <input type="text" ref={nameRef} onChange={nameChangeHandler} onBlur={nameBlurHandler} className={namevalid} id="example3cols1Input" placeholder="Name of department - pole"/>
            ...
            <div className="col-md-4">
              <div className="form-group">
                <label className="form-control-label" htmlFor="example3cols3Input">Business Line<span className="text-danger">*</span></label>
                <Selec multi={multiple} ref={buRef} data={budata}/>
              </div>
            </div>
          </div>
